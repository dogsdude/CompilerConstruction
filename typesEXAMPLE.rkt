...
(struct VarValue (type
                   ...
                   ;WORRIED ABOUT ESCAPE VALUE HERE!
                   ;Care about these two for escaping!
                   ;Making changes here will need to go back and change parser to take two extra parameters
                   ;We set level to 0 and escape? to no
                   [level #:mutable]
                   [escape? #:mutable]
